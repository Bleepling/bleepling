...
Der sichtbare Hauptworkflow läuft im Projektstand **1.5.3** vor allem über den Reiter **„Prüfen & Entscheiden“** für den eigentlichen Anonymisierungsprozess. Ergänzend stehen der Reiter **„Schnitt & Kapitel“** für die vorbereitende manuelle Clip-Erzeugung aus Quellvideos, der Reiter **„Titelkarten“** für statische PNG-Karten mit interaktiv positionierbaren Dachzeilen, Titelbox und Logo-Feldern, der erweiterte Reiter **„Medien“** als projektweite Bestandsübersicht sowie zentrale Render-Einstellungen im Reiter **„Einstellungen / Logs“** zur Verfügung.
...
Für das Anwenderhandbuch gilt ab **1.5.3**: Die primäre Quelle ist `docs/Bleepling_Benutzerhandbuch.md`. Änderungen an sichtbarer Hilfe- oder Handbuchlogik sollten deshalb nach Möglichkeit sowohl in der App als auch in dieser Markdown-Datei nachvollziehbar fortgeführt werden.
