...
Der Arbeitsstand **1.5.3** verwendet insbesondere diese sichtbaren Reiter:
...
Im Projektstand 1.5.3 werden unter anderem diese projektbezogenen Pfade verwendet:
...
Die zentrale Benutzerdokumentation liegt als Markdown-Datei im Projekt vor:

- `docs/Bleepling_Benutzerhandbuch.md`
- `docs/INSTALLATION_WINDOWS_FUER_ABSOLUTE_ANFAENGER.md`

Zusätzlich ist das Handbuch direkt in die Anwendung integriert. Über den Button **„Handbuch öffnen“** kann es in der laufenden App angezeigt, durchsucht und bei Bedarf als HTML exportiert werden.

Für Menschen ohne Entwicklerhintergrund gibt es zusätzlich eine besonders kleinschrittige Installationsanleitung:

- [Windows-Installationsanleitung für absolute Anfänger](docs/INSTALLATION_WINDOWS_FUER_ABSOLUTE_ANFAENGER.md)

PDF- oder DOCX-Fassungen gehören seit **1.5.3** nicht mehr zum offiziellen Release-Bestand.
